...
class NoteCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create note_category" do
    assert_difference("NoteCategory.count") do
      post note_categories_url, params: { note_category: { category_name: @note_category.category_name } }
    end
  ...
  test "should update note_category" do
    patch note_category_url(@note_category), params: { note_category: { category_name: @note_category.category_name } }
